...
NDIR=$LMSDIR/wsj_dict_dev93_no_bos
...
NDIR=$LMSDIR/wsj_unigram_no_bos
...
NDIR=$LMSDIR/wsj_bigram_nondet_no_bos
NLM=$NDIR/lm_bg.arpa.gz
mkdir -p $NDIR
cp $LMFILE $NLM
...
NDIR=$LMSDIR/wsj_bigram_nondet_with_bos
NLM=$NDIR/lm_bg.arpa.gz
mkdir -p $NDIR
cp $LMFILE $NLM
...
NDIR=$LMSDIR/wsj_trigram_no_bos
...
NDIR=$LMSDIR/wsj_dict_dev93_with_bos
...
NDIR=$LMSDIR/wsj_unigram_with_bos
NLM=$NDIR/lm_unigram.arpa.gz
mkdir -p $NDIR
gzip -cd $LMFILE | \
	arpa_lm_to_unigram_lm.py | \
...
NDIR=$LMSDIR/wsj_bigram_with_bos
NLM=$NDIR/lm_bg.arpa.gz
mkdir -p $NDIR
cp $LMFILE $NLM
...
NDIR=$LMSDIR/wsj_trigram_with_bos
NLM=$NDIR/lm_tg.arpa.gz
mkdir -p $NDIR
cp $LMFILE $NLM
