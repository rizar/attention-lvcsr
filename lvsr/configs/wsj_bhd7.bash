...
$LVSR/lvsr/run.py --num-epochs=3 train wsj_bhd7.zip $LVSR/lvsr/configs/wsj_bhd4.yaml\
    regularization.max_norm 0
$LVSR/lvsr/run.py --params wsj_bhd7.zip train wsj_bhd7r.zip $LVSR/lvsr/configs/wsj_bhd4.yaml\
